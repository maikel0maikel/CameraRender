...
//				mUVCCamera.setFrameCallback(mIFrameCallback, UVCCamera.PIXEL_FORMAT_NV21);
                mUVCCamera.setFrameCallback(mIFrameCallback, UVCCamera.PIXEL_FORMAT_RGBX);//PIXEL_FORMAT_YUV420SP
        ...
        public void handleCaptureStill(final String path) {
            ...
            if (mWeakCameraView == null || mWeakCameraView.get() == null) return;
...
//			}
            if (mWeakCameraView != null && mWeakCameraView.get()!= null) {
...
//				}
        ...
        private final MediaEncoder.MediaEncoderListener mMediaEncoderListener = new MediaEncoder.MediaEncoderListener() {
            ...
            public void onPrepared(final MediaEncoder encoder) {
                ...
                mIsRecording = true;
                if (encoder instanceof MediaVideoEncoder && mWeakCameraView.get() != null)
                    try {
