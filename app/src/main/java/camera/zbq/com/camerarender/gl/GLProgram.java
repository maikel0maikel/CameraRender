...
public class GLProgram {
    ...
    public void buildTextures(Buffer y, Buffer u, Buffer v, int width, int height) {
        ...
        if (videoSizeChanged) {
            ...
            Log.d("zbq", "buildTextures videoSizeChanged: w=" + _video_width + " h=" + _video_height);
        }

        // building texture for Y data
        if (_ytid < 0 || videoSizeChanged) {
            if (_ytid >= 0) {
                Log.d("zbq", "glDeleteTextures Y");
            ...
            _ytid = textures[0];
            Log.d("zbq", "glGenTextures Y = " + _ytid);
        }
        ...
        if (_utid < 0 || videoSizeChanged) {
            ...
            checkGlError("glGenTextures");
            _utid = textures[0];
            Log.d("zbq", "glGenTextures U = " + _utid);
        }
        ...
        if (_vtid < 0 || videoSizeChanged) {
            ...
            checkGlError("glGenTextures");
            _vtid = textures[0];
            Log.d("zbq", "glGenTextures V = " + _vtid);
        }
